...
function barSlider(id, min = 1, max = 100, value = 50) {
    const sliderContainer = document.getElementById('sliderContainerNew');
    let s = sliderContainer.style;
    s.width = '150px';
    s.height = '20px';
...
function stdSlider(id, min = 1, max = 100, value = 50, display = 'flex') {
